  ...
  <div>
    ...
    <a-form :form="form">
      <a-form-item v-bind="formItemLayout" label="感染诊断">
        <a-select defaultValue="下呼吸道感染" style="width: 120px" v-model="caseReport.infectionDiagCode">
      ...
      <a-form-item v-bind="formItemLayout" label="易感因素">
        <div>
          ...
          <a-checkbox-group :options="plainOptions" v-model="checkedList" @change="onChange" />  <!--checkedList caseReport.preFactor-->
        </div>
      </a-form-item>
      <a-form-item v-bind="formItemLayout" label="备注">
        <a-textarea placeholder="备注" :autosize="{ minRows: 2, maxRows: 6 }" v-model="caseReport.preFactorElse"/>
      </a-form-item>
    </a-form>
  </div>
</template>
